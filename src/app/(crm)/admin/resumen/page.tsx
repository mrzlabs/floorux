...
export default async function ResumenPage() {
  ...
  return (
    <AdminShell profile={profile} comercio={comercio} view="resumen" lowStockCount={lowCount} operating={operating} returnPath={returnPath}>
      <AdminResumen comercioId={profile.comercio_id!} />
    </AdminShell>
  );
}
